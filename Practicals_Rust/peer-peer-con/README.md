...
standard library** — zero external crates.
...
### 1. Compile & run (same machine, two terminals)
...
**Terminal 2 (Peer "Bob"):**
```bash
cargo run Bablya 7879 127.0.0.1:7878
```
...
2. On Machine A: `cargo run  Anirudha 7878 <Machine_B_IP>:7879`
3. On Machine B: `cargo run Bablya 7879 <Machine_A_IP>:7878`
